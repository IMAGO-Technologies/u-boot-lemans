...
#ifndef __LS2_LEMANS_H
#define __LS2_LEMANS_H
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"bootfile=/boot/Image.gz\0" \
	"fdtfile=/boot/fsl-ls2088a-lemans.dtb\0" \
	"mmcboot=ext2load mmc 0:1 0xa2700000 ${dplfile};" \
	"fsl_mc apply DPL 0xa2700000;ext2load mmc 0:1 0xa0000000 ${bootfile};" \
	"unzip 0xa0000000 0xb0000000;ext2load mmc 0:1 0xa1000000 ${fdtfile};" \
...
/* Depending on PCIe hardware configuration, we need more stream IDs than the default setting: */
